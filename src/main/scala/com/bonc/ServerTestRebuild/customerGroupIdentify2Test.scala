 ...
 */
object customerGroupIdentify2Test {
  def main(args: Array[String]): Unit = {
    ...
    val readInRDD: RDD[(String, String, String, String, String, String, String, String, String)] = hiveContext.sql(readSQL).rdd.map(x => {
      var imsi: String = ""
...
//      }
      (imsi, starttime, endtime, staytime, longitude, latitude, code, grid, imei)
    })
    println("readInRDD:" + readInRDD.count())

    val traceRDD: RDD[(String, Trace)] = readInRDD.map((x: (String, String, String, String, String, String, String, String, String)) => {
