...
object cityBetweenOD {
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setAppName("cityBetweenOD")
    ...
    while (gc != null) {
      if (!gc.contains("-")) {
        ...
        if (gc.split("\\|").length >= 5) {
          if (gc.split("\\|", -1)(0).isEmpty) {
            G2List.put(gc.split("\\|")(2), gc.split("\\|")(4) + "_" + gc.split("\\|")(3) + "_" + "blank")
          }
          else {
            if (gc.split("\\|")(2).contains("_")) {
              G2List.put(gc.split("\\|")(2), gc.split("\\|")(4) + "_" + gc.split("\\|")(3) + "_" + gc.split("\\|")(0))
            } else {
              G4List.put(gc.split("\\|")(2), gc.split("\\|")(4) + "_" + gc.split("\\|")(3) + "_" + gc.split("\\|")(0))
            }
          }
        }
      }
    ...
    val inputRDD: RDD[(String, String, String, String, String, String)] = hiveContext.sql(readSQL)
      ...
      .map(x => {
        ...
        val loctype: String = x.get(1).toString
        val stime: String = x.get(2).toString
        val maincellid: String = x.get(3).toString
    ...
    val traceRDDCount: Long = traceRDD.count()
    println(traceRDDCount)

    val resultRDD: RDD[(String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String)] = traceRDD.map(x => {
      ...
      for (elem <- x.wheres) {
        breakable {
          ...
          if (!thisCounty.equals(lastCounty)) {
    ...
    sc.stop()
    println("success!————市级OD完成" + str_date)
